...
\item 提哥亞 (Tekoa)\\
 \parbox{\linewidth}{ \begin{wrapfigure}{r}{0.6\textwidth}
\centering
\includegraphics[width=0.6\textwidth]{ZongJie/Appendix/DiMingRenMing/fig/TiGeYa1}
  \end{wrapfigure}
  }% \end{minipage}
...
\centering
%\includegraphics[width=0.6\textwidth]{ZongJie/figs/DXianZhiFigs/ZongJie/TiGeYa1}
\includegraphics[width=0.6\textwidth]{ZongJie/Appendix/DiMingRenMing/fig/TiGeYa1}
\end{wrapfigure}
